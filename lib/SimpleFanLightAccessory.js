...
class SimpleFanLightAccessory extends BaseAccessory {
    ...
    _registerCharacteristics(dps) {
        ...
        this.device.on('change', (changes, state) => {
            // console.log(JSON.stringify(changes), JSON.stringify(state));
            // this.log(JSON.stringify(changes), JSON.stringify(state));
            // this.log.info(JSON.stringify(changes), JSON.stringify(state));
            this.log.warn(JSON.stringify(changes), JSON.stringify(state));
            ...
            console.log(changes.hasOwnProperty(this.dpRotationSpeed),this.convertRotationSpeedFromHomeKitToTuya(characteristicRotationSpeed.value), changes[this.dpRotationSpeed], this.convertRotationSpeedFromHomeKitToTuya(characteristicRotationSpeed.value) !== changes[this.dpRotationSpeed])
